...
export function LoginForm({
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="min-h-80 overflow-hidden p-0 md:min-h-120">
        <CardContent className="grid min-h-80 p-0 md:min-h-120 md:grid-cols-2">
          <div className="flex flex-col items-center justify-center gap-8 px-4 py-8">
            <div className="flex flex-col items-center gap-2 text-center">
              <h1 className="text-2xl font-bold">Welcome to Dompet</h1>
              <p className="text-muted-foreground text-balance">
                Manage your finances with ease, no downloads required.
              </p>
            </div>
          ...
          <div className="bg-muted relative hidden items-center justify-center md:flex">
            <img
              src="/wallet-alt-svgrepo-com.svg"
